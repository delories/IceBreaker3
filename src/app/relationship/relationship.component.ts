...
//                        continue;
        ...
        for (var i = 0; i < data1.length; i++) {
          var temp = {};
          temp.source = data1[i].fromName;
          temp.target = data1[i].toName;
          if (data1[i].value[0] == "1") {
            temp.value = "投资";
          } else
            temp.value = data1[i].value.substring(1);
          link.push(temp);
        }
        console.log(link);
...
//     $.get(baseUrl + this.id.substr(25), function (data1) {
//       console.log(this.id);
//       var data = [];      //存储结点信息
//       var dot = [];       //用于去重操作
//       var link = [];      //存储边集信息
...
//           console.log(data1[i].fromID);
//           console.log(id);
//           console.log(qichachaUrl + id);
//           dot.push(data1[i].fromName);
//           if (data1[i].fromID == qichachaUrl + id) {
// //                        dot.push(data1[i].fromName);
//             temp.name = data1[i].fromName;
//             temp.category = 0;
//             temp.draggable = true;
...
//         if (dot.indexOf(data1[i].toName) == -1) {
//           dot.push(data1[i].toName);
//           if (data1[i].toID == qichachaUrl + id) {
// //                        dot.push(data1[i].fromName);
//             temp.name = data1[i].toName;
//             temp.category = 0;
//             temp.draggable = true;
